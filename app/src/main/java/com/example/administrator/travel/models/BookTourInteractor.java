...
public class BookTourInteractor {
    ...
    public void getTourBooking(String tourStartId, Context context, final OnBookTourFinishedListener listener){
    ...
    public void getPrices(String tourStartId, final OnBookTourFinishedListener listener){
        final FirebaseDatabase database = FirebaseDatabase.getInstance();
